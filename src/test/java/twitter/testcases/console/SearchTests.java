...
public class SearchTests {
	...
	private String location = "C:\\Users\\DELL\\eclipse-workspace\\testing\\reportSearchTests.html";
...
//		System.setProperty("webdriver.chrome.driver", "D:\\DevOps tools\\Selenium\\Drivers\\chromedriver_win32\\chromedriver.exe");
	...
	@Test(priority = 1)
  	public void tc_002_CheckSearch_Person() {
	  	try {
	  		WebElement x = driver.findElement(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main/div/div/div/div[2]/div/div[2]/div/div/div/div[1]/div/div/div/form/div[1]/div/div/div[2]/input"));
	  		x.sendKeys("Amitabh Bachchan");
	  		Thread.sleep(2000);
	  		x.submit();
	  		Thread.sleep(2000);
	  		
	  		driver.findElement(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main/div/div/div/div[1]/div/div[2]/div/div/section/div/div/div[10]/div/div/div/div[2]/div[1]/div[1]/a/div/div[1]/div[1]/span/span")).click();
	  		Thread.sleep(2000);
	  		
	  		driver.findElement(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/header/div/div/div/div[1]/div[2]/nav/a[1]/div/div[2]/span")).click();
	  		Thread.sleep(2000);
	  	}
	  	catch(Exception e) {
			test.log(LogStatus.ERROR, "The Login test Failed");
	...
	@Test(priority = 2)
  	public void tc_003_CheckSearch_Hashtag() {
	  	try {
	  		WebElement x = driver.findElement(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main/div/div/div/div[2]/div/div[2]/div/div/div/div[1]/div/div/div/form/div[1]/div/div/div[2]/input"));
	  		x.sendKeys("#COVID19");
	  		Thread.sleep(2000);
	  		...
	  		driver.findElement(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main/div/div/div/div[1]/div/div[2]/div/div/section/div/div/div[1]/div/div/div[2]/a/div/span/span")).click();
	  		Thread.sleep(2000);
	  		
	  		driver.findElement(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main/div/div/div/div[1]/div/div[2]/div/div/section/div/div/div[1]/div/div/div[3]/a/div/span/span")).click();
	  		Thread.sleep(2000);
	  		...
	  		driver.findElement(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main/div/div/div/div[1]/div/div[2]/div/div/section/div/div/div[3]/div/div/article/div/div/div/div[2]/div[2]/div[2]/div[1]/div")).click();
	  		Thread.sleep(2000);
	  	}
	  	catch(Exception e) {
			test.log(LogStatus.ERROR, "The Login test Failed");
